...
dat1 = data.frame(dat1)
#
dat1 = dat1[, c("bile", "obese_nash_fc", "obese_nash_p", "hmdb_id")]
...
#
write.table(df_piumet, "piumet_lip_bi_obesh.txt", sep = "\t", row.names = F, col.names = F, quote = F)
write.table(dat1, "lipid_bile_obese_nash.txt", sep = "\t", row.names = F)
